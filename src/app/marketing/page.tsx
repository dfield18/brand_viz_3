...
export const metadata: Metadata = {
  title: {
    absolute: "Why aiSaysWhat — AI brand visibility for companies and marketing teams",
  },
  description:
...
const PRICING_TIERS = [
  ...
  },
  {
    ...
    features: [
      "5 brands with weekly snapshots",
      "All 5 AI platforms",
      "Real logged history (not estimated)",
